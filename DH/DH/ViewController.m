...
- (void)testDH {
    NSLog(@"😍😍😍😍😍😍😍😍");
    GSPairKey* a = [GSDH generatePairKey];
    NSLog(@"user A pubKey:%@ \n privKey:%@",a.pubKey,a.privKey);
    GSPairKey* b = [GSDH generatePairKey];
...
//    b.privKey = @"";
    NSString* akey = [GSDH computeKey:b.pubKey privKey:a.privKey];
    NSString* bKey = [GSDH computeKey:a.pubKey privKey:b.privKey];
    
    NSString* plainText = @"Howareyoufinethankyou你好，\t\n\t\f天空灰的向哭过，离开你以后areyou ok🤑🤑🤑 ";
    NSString* encryptText = [GSDH encryptMessage:plainText key:akey];
    NSString* decrpty = [GSDH decryptMessage:encryptText key:akey];
